...
let SubscriptionController = class SubscriptionController {
    ...
    async createSubscription(request, createSubscriptionDto) {
        return this.subscriptionService.createSubscription(request, createSubscriptionDto);
    }
    async verifyPayment(request, verifySubscriptionDto) {
        return this.subscriptionService.verifyPayment(request, verifySubscriptionDto);
    }
    async renewSubscription(request, renewSubscriptionDto) {
        return this.subscriptionService.initiateSubscriptionRenewal(request, renewSubscriptionDto);
    }
    async upgradeSubscription(request, param, upgradeSubscriptionDto) {
        return this.subscriptionService.initiateSubscriptionUpgrade(request, param.subscription_id, upgradeSubscriptionDto);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, subscription_dto_1.VerifySubscriptionDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Post)('upgrade/:subscription_id'),
    (0, auth_decorator_1.Public)(),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, subscription_dto_1.UpgradeSubscriptionDto]),
    __metadata("design:returntype", Promise)
