...
exports.PlanModule = PlanModule = __decorate([
    (0, common_1.Module)({
        controllers: [plan_controller_1.SubscriptionPlanController],
        providers: [prisma_service_1.PrismaService, log_service_1.LogService, plan_service_1.SubscriptionPlanService],
    })
], PlanModule);
